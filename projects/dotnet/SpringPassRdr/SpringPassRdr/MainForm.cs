...
namespace SpringPassRdr
{
    public partial class MainForm : Form
    {
        ...
        void CardConnectedCallback(SCardChannel cardChannel)
        {
            ...
            if (googleTerminal.DoTransaction(cardChannel, out GoogleVasData data1, out GoogleVasError error1))
            {
            ...
            if (appleTerminal.DoTransaction(cardChannel, out AppleVasData data2, out AppleVasError error2))
            {
